 ...
 */
final class Version20190816104418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot ADD caissier_id INT DEFAULT NULL, DROP caissier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot ADD caissier VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP caissier_id');
    }
}
