...
// Returns the private 'App\Repository\OperationsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OperationsRepository.php';

return $this->privates['App\\Repository\\OperationsRepository'] = new \App\Repository\OperationsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
