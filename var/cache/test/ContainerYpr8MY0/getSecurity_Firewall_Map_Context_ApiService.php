...
}, 4), ($this->privates['security.exception_listener.api'] ?? $this->load('getSecurity_ExceptionListener_ApiService.php')), ($this->privates['security.logout_listener.api'] ?? $this->load('getSecurity_LogoutListener_ApiService.php')), ($this->privates['security.firewall.map.config.api'] ?? $this->load('getSecurity_Firewall_Map_Config_ApiService.php')));
